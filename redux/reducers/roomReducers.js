...
export const createNewRoomReducer = (state = { room: {} }, action) => {
  switch (action.type) {
...
// All rooms reducer
export const getAllRoomsByAdminReducer = (state = { rooms: [] }, action) => {
  switch (action.type) {
...
export const getRoomDetailsReducer = (state = { room: {} }, action) => {
  switch (action.type) {
