        ...
        <div className="col-12 col-lg-8 mt-5 booking-details">
          {booking && booking.room && booking.user && (
            <>
              ...
              <p>
                <b>Amount:</b> GHS {booking.amountPaid * 0.01}.00
              </p>
              ...
              {user && user.role === 'admin' && (
                <>
                  ...
                  <p className="redColor">
                    <b>{booking.paymentInfo.reference}</b>
                  </p>
                </>
              )}
              ...
              <div className="cart-item my-1">
                <div className="row my-5">
                  ...
                  <div className="col-4 col-lg-2 mt-4 mt-lg-0">
                    <p>GHS {booking.room.pricePerNight}</p>
                  </div>

                  <div className="col-4 col-lg-3 mt-4 mt-lg-0">
                    <p>
                      {booking.daysOfStay === 1
                        ? `${booking.daysOfStay} Day`
